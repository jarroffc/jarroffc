...
# Unduh file tema
wget -O /root/stellar.zip https://github.com/jarroffc/jarroffc/raw/main/stellar.zip
...
while true; do
  ...
  echo -e "${RED}'ggg      ,gg'''  .    ggg       Auto Installer Jarrofficiall   ${NC}"
  echo -e "${RED}gggg      gg     ,     ggg      ------------------------  ${NC}"
  echo -e "${RED}ggg:     gg.     -   ,ggg       • Telegram : Jarrofficiall      ${NC}"
  echo -e "${RED} ggg:     ggg._    _,ggg        • Creadit  : Jarrofficiall  ${NC}"
  echo -e "${RED} ggg.    '.'''ggggggp           • Support by Jarrofficiall  ${NC}"
